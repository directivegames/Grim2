...
Everything under `.agents/skills/` is replaced on SDK project update — do not
edit these files by hand. `references/hotkeys.md` in particular mirrors the
editor's in-app Hot Keys dialog and is generated.
